			...
			return function(e) {
				return "form" in e
					? e.parentNode && !1 === e.disabled
						? "label" in e ? ("label" in e.parentNode ? e.parentNode.disabled === t : e.disabled === t) : e.isDisabled === t || (e.isDisabled !== !t && ae(e) === t)
						: e.disabled === t
						...
						? function(e, t) {
								...
								return (
									...
									(1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!d.sortDetached && t.compareDocumentPosition(e) === n)
										? e === C || (e.ownerDocument === m && y(m, e)) ? -1 : t === C || (t.ownerDocument === m && y(m, t)) ? 1 : u ? P(u, e) - P(u, t) : 0
										: 4 & n ? -1 : 1)
								);
						  }
						: function(e, t) {
											...
											: "^=" === r
												...
												: "*=" === r
													...
													: "$=" === r
														...
														: "~=" === r ? -1 < (" " + t.replace(F, " ") + " ").indexOf(i) : "|=" === r && (t === i || t.slice(0, i.length + 1) === i + "-"));
					};
				},
		...
		k.each(
			...
			function(r, i) {
				k.fn[r] = function(e, t) {
					...
					return (
						"Until" !== r.slice(-5) && (t = e), t && "string" == typeof t && (n = k.filter(t, n)), 1 < this.length && (O[r] || k.uniqueSort(n), H.test(r) && n.reverse()), this.pushStack(n)
					);
				};
			}
		);
										...
										e = function() {
											...
											if (!(i < u)) {
												...
												(t = e && ("object" == typeof e || "function" == typeof e) && e.then),
													m(t)
														? s ? t.call(e, l(u, o, M, s), l(u, o, I, s)) : (u++, t.call(e, l(u, o, M, s), l(u, o, I, s), l(u, o, M, o.notifyWith)))
		...
		k.each(
			{
				...
				which: function(e) {
					...
					return null == e.which && Te.test(e.type)
						...
						: !e.which && void 0 !== t && Ce.test(e.type) ? (1 & t ? 1 : 2 & t ? 3 : 4 & t ? 2 : 0) : e.which;
				}
			},
			k.event.addProp
		),
		...
		((nt.propHooks = {
			_default: {
				...
				set: function(e) {
					k.fx.step[e.prop]
						? k.fx.step[e.prop](e)
						: 1 !== e.elem.nodeType || (!k.cssHooks[e.prop] && null == e.elem.style[Ge(e.prop)]) ? (e.elem[e.prop] = e.now) : k.style(e.elem, e.prop, e.now + e.unit);
				}
			}
				...
				if (3 !== o && 8 !== o && 2 !== o)
					return "undefined" == typeof e.getAttribute
						...
						: ((1 === o && k.isXMLDoc(e)) || (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? ht : void 0)),
						  void 0 !== n
								? null === n ? void k.removeAttr(e, t) : i && "set" in i && void 0 !== (r = i.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n)
								: i && "get" in i && null !== (r = i.get(e, t)) ? r : null == (r = k.find.attr(e, t)) ? void 0 : r);
			},
			attrHooks: {
				type: {
					set: function(e, t) {
			...
			return arguments.length
				...
				: t
					? (r = k.valHooks[t.type] || k.valHooks[t.nodeName.toLowerCase()]) && "get" in r && void 0 !== (e = r.get(t, "value"))
						? e
						: "string" == typeof (e = t.value) ? e.replace(wt, "") : null == e ? "" : e
					: void 0;
		}
	}),
		k.extend({
